...
static const uint8_t aes_default_key[16] = {
...
static const int aes_ncol = 4; //col number
static const int aes_nkeys = 4; //32 words in key
static const int aes_nrounds = 10;
